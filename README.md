...
Data Transformation
Here is the Python script transforming the data using Databricks: [Transform data](BreadcrumbsAzureDataEngineer_FinancialData/Data%20Transformation/Bronze%20data%20transformation.py)
